    ...
    recipeDetails: {
        "breakfast_american_style_pancakes": {
            ru: {
                ...
                instructions: [
                    "Смешайте кефир, яйцо, сахар и масло до однородной консистенции.",
        ...
        "snaks_garlic_croutons":  {
            ru: {
                title: "Чесночные сухарики",
                meta:  {
                    time: "15 мин",
                    servings: "2 порции"
                  },
                ingredients: [
                "40 г белого хлеба (4 ломтика)", 
                "4 головки чеснока", 
                "5 мл растительного масла", 
                "Щепотка соли", 
                ...
                instructions: [
                "Разогрейте духовку до 180°C.", 
                "Нарежьте хлеб небольшими кубиками. Я предпочитаю срезать корочки. Переложите нарезанный хлеб в миску.", 
                "В отдельной миске смешайте масло, измельченный чеснок и соль.", 
                "Залейте полученной смесью хлеб, накройте миску тарелкой и энергично встряхните, чтобы масло равномерно распределилось по всем кубикам.", 
                "Выложите хлеб на противень в один слой и запекайте 10–15 минут до золотистого цвета.",
            ...
            en: {
                ...
                instructions: [
                "Preheat the oven to 180°C.", 
                "Cut the bread into small cubes. If desired, remove the crusts. Transfer to a bowl.", 
                "In a separate bowl, combine the oil, finely grated garlic, and salt.", 
                "Pour the seasoned oil over the bread, cover the bowl with a plate, and shake gently to distribute evenly.", 
                "Spread the bread cubes in a single layer and bake for 10–15 minutes, until golden and crisp.", 

                ],
                note: "You may enrich the oil with your preferred seasonings, such as dried oregano, basil, or even finely grated Parmesan."
             }
        },
        "soup_chicken_broth":  {
            ru: {
        ...
        "dessert_moscow_style_sugar_bun":  {
            ru: {
                ...
                "7 г сухих дрожжей", 
                "1 ст.л. сливок (можно заменить на молоко)", 
                "1 ч.л. соли", 
                "1-2 г ванилина", 
        ...
        "dessert_napoleon_cake":  {
            ru: {
                ...
                "Когда коржи и крем полностью остынут, распределите крем по каждому коржу. Посыпьте верх торта крошкой и уберите в холодильник. Через 2-3 часа торт уже можно есть, но он будет менее пропитанным. На следующий день торт станет максимально мягким.", 
